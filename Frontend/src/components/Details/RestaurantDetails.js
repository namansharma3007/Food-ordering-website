...
export default function RestaurantDetails() {
  ...
  const fetchMenu = () => {
    fetch(`https://final-project-zomato.herokuapp.com/menu/${rName}`, { method: 'GET' })
  ...
  const openRazorpay = async () => {
    try {
      ...
      let orderData;
      orderData = await fetch('https://final-project-zomato.herokuapp.com/payment',
        {
          method: 'POST',
      ...
      const options = {
        ...
        handler: function (response) {
          ...
          fetch('https://final-project-zomato.herokuapp.com/payment/save',
            {
              method: 'POST',
              headers: { 'Content-Type': 'application/json' },
              body: JSON.stringify({
  ...
  useEffect(() => {
    fetch(`https://final-project-zomato.herokuapp.com/restaurants/details/${rName}`, { method: 'GET' })
      .then(response => response.json())
