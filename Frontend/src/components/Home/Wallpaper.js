...
export default class Wallpaper extends Component {
  ...
  fetchRestaurants = (event) => {
    ...
    fetch(`https://final-project-zomato.herokuapp.com/restaurants/${event.target.value}`, { method: 'GET' })
      .then(response => response.json())
      .then(data => this.setState({ restaurants: data.data }))
  }

  componentDidMount() {
    fetch('https://final-project-zomato.herokuapp.com/location', { method: 'GET' })
      .then(response => response.json())
