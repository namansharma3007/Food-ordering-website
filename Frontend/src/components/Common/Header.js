...
export default function Header() {
    ...
    const onSubmit = (event) => {
        ...
        try {
            ...
            axios.post('https://final-project-zomato.herokuapp.com/userData/createUser', options)
    ...
    const sendUserDataToBackend = async (event) => {
        ...
        try {
            ...
            await axios.post('https://final-project-zomato.herokuapp.com/userData/getUser', requirements)
